...
<html lang="en">
  ...
  %>
  <h1>I am Getting Forward Data <%=request.getParameter("x") %></h1>
  <%=count %>
  <%-- <jsp:useBean id="obj" class="com.brainmentors.exam.dto.UserDTO">
  <jsp:setProperty name="userid1" property="userid" />
  <jsp:setProperty name="pwd" property="pwd" />
  <jsp:setProperty name="*" property="*"/>
  <jsp:getProperty name="userid"/>
</jsp:useBean> --%>
  <%

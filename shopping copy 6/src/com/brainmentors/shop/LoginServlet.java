...
//@WebServlet("/login")
//@WebServlet(urlPatterns = "/login" ,initParams = @WebInitParam(name="email",value="ram@yahoo.com"))
public class LoginServlet extends HttpServlet { 
	...
	private String getDesign(String userid) {
		String result=  
				"</li> </ul> </nav>\\\\n\\\" + \\n\" <div class='container-fluid'> <div class='row'> <nav class='col-md-2 d-none d-md-block bg-light sidebar'> <div class='sidebar-sticky'> <ul class='nav flex-column'> <li class='nav-item'> <a class='nav-link active' href='#'> <span data-feather='home'></span> Dashboard <span class='sr-only'>(current)</span> </a> </li> <li class='nav-item'> <a class='nav-link' href='order.online'> <span data-feather='file'></span> Orders </a> </li> <li class='nav-item'> <a class='nav-link' href='#'> <span data-feather='shopping-cart'></span> Products </a> </li> <li class='nav-item'> <a class='nav-link' href='#'> <span data-feather='users'></span> Customers </a> </li> <li class='nav-item'> <a class='nav-link' href='#'> <span data-feather='bar-chart-2'></span> Reports </a> </li> <li class='nav-item'> <a class='nav-link' href='#'> <span data-feather='layers'></span> Integrations </a> </li> </ul>\n" + 
				"\n" + 
				...
				"\n" + 
				" <main role='main' class='col-md-9 ml-sm-auto col-lg-10 px-4'> <div class='d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom'> <h1 class='h2'>Welcome "+userid+" Active Users are "+UserCount.count+"</h1> <div class='btn-toolbar mb-2 mb-md-0'> <div class='btn-group mr-2'> <button type='button' class='btn btn-sm btn-outline-secondary'>Share</button> <button type='button' class='btn btn-sm btn-outline-secondary'>Export</button> </div> <button type='button' class='btn btn-sm btn-outline-secondary dropdown-toggle'> <span data-feather='calendar'></span> This week </button> </div> </div>\n" + 
				"\n" + 
...
//		if((uid!=null && pwd!=null) && uid.equals(pwd)) {
			...
			out.println(partI());
			System.out.println("Before Request Dispatcher Call.....");
